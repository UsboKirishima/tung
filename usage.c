...
void show_usage(char **argv) {
	printf("Usage: tung [OPTIONS]\n\n"
		...
		"      --srcaddr <ip>       Set source address (Omit for random source addr)\n"
		"      --srcport <port>     Set source port (Omit for random source port)\n\n"
		...
		"                             Example: %s -a syn --scan 30-40,60-70 --target 34.54.65.34\n"
		"                             Example: %s -a ack --scan all --target 34.54.65.34\n"
		"                             Example: %s -a syn --scan common --target 34.54.65.34\n\n"
...
void show_attacks_list(char **argv) {
	...
	printf("TUNG ATTACKS LIST\n"
		...
		"TCP\n"
                ...
                "SCAN\n"
                "  syn       - SYN scan attack (half-open scan) [Stealth]\n"
                "  ack       - ACK scan attack (firewall mapping)\n\n"
       	        "Example:\n"
